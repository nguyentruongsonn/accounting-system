...
class ChartOfAccountsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // The chart seed is a bootstrap operation, not a multi-tenant import.
        // Refuse an ambiguous company set before creating or changing any
        // account so an operator cannot accidentally copy the same chart into
        // every operational tenant.
        if ($companies->count() > 1) {
            throw new \RuntimeException('ChartOfAccountsSeeder requires exactly one company context before writing chart accounts.');
        }
