...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sales_discounts', function (Blueprint $table) {
            ...
            $table->string('voucher_type', 100)->default('sales_discount');
            ...
            $table->decimal('sub_total', 15, 2)->default(0); // Tổng tiền giảm giá (trước thuế)
            $table->decimal('tax_amount', 15, 2)->default(0);
            $table->decimal('total_amount', 15, 2)->default(0); // Tổng thanh toán
