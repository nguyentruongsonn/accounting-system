    ...
    public function up(): void
    {
        if (! Schema::hasTable('purchase_returns')) {
            Schema::create('purchase_returns', function (Blueprint $table) {
                ...
                $table->string('voucher_type', 100)->default('purchase_return');
                ...
                $table->boolean('is_outward')->default(true); // Xuất kho trả lại hàng mua
                $table->boolean('is_export_slip')->default(true); // Alias for is_outward
                $table->boolean('is_decrease_debt')->default(true); // Giảm trừ công nợ phải trả NCC (331)
        ...
        if (! Schema::hasTable('purchase_return_lines')) {
            Schema::create('purchase_return_lines', function (Blueprint $table) {
                ...
                // Định khoản VAS TT200: Nợ 331 / Có 1561, 152, 153, 1331
                $table->string('debit_account', 20)->default('331'); // Phải trả người bán / 1111 / 1121
                $table->string('credit_account', 20)->default('1561'); // Hàng hóa / 152 / 153
                ...
                // Thuế GTGT được khấu trừ giảm ghi Có 1331
