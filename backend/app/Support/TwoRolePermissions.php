...
final class TwoRolePermissions
{
    public const ACCOUNTANT = [
        ...
        'budgets.view',
        'budgets.manage',
        'tools.equipment.view',
        'tools.equipment.create',
        'tools.equipment.update',
        'tools.equipment.delete',
        ...
        'gl.periods.view',
        'gl.periods.signoff.prepare',
        'gl.periods.signoff.submit',
