...
class PurchaseDiscountResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'voucher_type' => $this->voucher_type ?? 'purchase_discount',
            ...
            'lines' => $this->whenLoaded('lines', function () {
                return $this->lines->map(function ($line) {
                    return [
                        'id' => $line->id,
                        'purchase_discount_id' => $line->purchase_discount_id,
                        ...
                        // Keep the API representation faithful to persisted
                        // evidence; no resource-level account selection.
