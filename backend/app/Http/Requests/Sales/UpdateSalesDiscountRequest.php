...
class UpdateSalesDiscountRequest extends FormRequest
{
    ...
    {
        $id = $this->route('discount') ?? $this->route('id') ?? $this->id;
        ...
        return [
            ...
            'voucher_number' => 'nullable|string|max:50|unique:sales_discounts,voucher_number,'.$id,
