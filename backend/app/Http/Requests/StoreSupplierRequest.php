...
class StoreSupplierRequest extends TenantAccountingRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'code' => [$required, 'string', Rule::unique('suppliers', 'code')->where(fn ($query) => $query->where('company_id', $this->companyId()))->ignore($id)],
            'name' => [$required, 'string'],
            'supplier_type' => 'nullable|string|in:org,personal',
