...
final class SalesInvoiceDimensionReadinessService
{
    ...
    public function inspect(SalesInvoice $invoice): array
    {
        ...
        try {
            ...
            if ($this->postingMode->isDirectPostingEnabled() || ! config('accounting.enforce_sales_invoice_posting_policy', true)) {
                return ['status' => 'not_required', 'can_enforce' => true, 'posting_date' => $postingDate, 'policy_id' => null, 'policy_contract_hash' => null, 'required_dimensions' => []];
            }
