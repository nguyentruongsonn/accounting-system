...
final class AccountReferenceService
{
    private const REFERENCES = [
        ...
        'opening_balance_tool_lines' => ['account_code'],
        'opening_balance_fixed_asset_lines' => ['asset_account', 'depreciation_account'],
        'opening_balance_prepaid_lines' => ['account_code'],
        'opening_balance_wip_lines' => ['account_code'],
    ];
    ...
    private function tenantQuery(string $table, int $companyId): Builder
    {
        ...
        if (str_ends_with($table, '_lines')) {
            ...
            [$parent, $foreignKey] = match ($table) {
                ...
                'opening_balance_tool_lines',
                'opening_balance_fixed_asset_lines',
                'opening_balance_prepaid_lines',
                'opening_balance_wip_lines' => ['opening_balance_packages', 'package_id'],
