...
Route::prefix('v1')->group(function () {
    ...
    Route::post('/auth/refresh', 'App\Http\Controllers\Api\V1\AuthController@refresh')->middleware('throttle:refresh');
});
...
Route::prefix('v1')->middleware(['auth:sanctum', 'active_account'])->group(function () {
    ...
    Route::get('/opening-balances/catalogues', [\App\Http\Controllers\Api\V1\OpeningBalanceController::class, 'catalogues'])
        ->middleware('permission:opening-balances.view');
    ...
    Route::post('/opening-balances/{id}/reopen', [\App\Http\Controllers\Api\V1\OpeningBalanceController::class, 'reopen'])
    ...
    // authority boundary.
    Route::get('/tools', [ToolEquipmentController::class, 'index'])
        ->middleware(['transactional_tenant', 'permission:tools.equipment.view']);
    Route::post('/tools', [ToolEquipmentController::class, 'store'])
        ->middleware(['transactional_tenant', 'permission:tools.equipment.create']);
    Route::get('/tools/allocate/preview', [ToolEquipmentController::class, 'previewAllocation'])
        ->middleware(['transactional_tenant', 'permission:tools.equipment.view']);
    ...
    Route::put('/tools/{id}', [ToolEquipmentController::class, 'update'])
        ->middleware(['transactional_tenant', 'permission:tools.equipment.update']);
    Route::delete('/tools/{id}', [ToolEquipmentController::class, 'destroy'])
        ->middleware(['transactional_tenant', 'permission:tools.equipment.delete']);
    ...
    Route::prefix('purchase')->middleware('transactional_tenant')->group(function () {
        ...
        Route::get('invoices/expense-allocation-candidates', 'App\Http\Controllers\Api\V1\Purchase\PurchaseInvoiceController@expenseAllocationCandidates')->middleware('permission:purchase.invoices.view');
        ...
        Route::get('received-invoices', 'App\Http\Controllers\Api\V1\Purchase\PurchaseReceivedInvoiceController@index')->middleware('permission:purchase.invoices.view');
        Route::post('received-invoices', 'App\Http\Controllers\Api\V1\Purchase\PurchaseReceivedInvoiceController@store')->middleware('permission:purchase.invoices.create');
        Route::post('received-invoices/{id}/link', 'App\Http\Controllers\Api\V1\Purchase\PurchaseReceivedInvoiceController@link')->middleware('permission:purchase.invoices.update');
    ...
    Route::prefix('reports')->middleware([
        ...
        Route::get('dashboard-trends', 'App\Http\Controllers\Api\V1\Report\DashboardTrendController@index');
