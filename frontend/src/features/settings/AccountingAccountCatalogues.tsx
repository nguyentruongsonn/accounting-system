...
import { Button, Form, Input, InputNumber, Popconfirm, Select, Space, Switch, Table, Tabs, Tag } from 'antd';
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 misa-p-12" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
        <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Thiết lập nội bộ — chưa cấp quyền ghi sổ</div>
        <div style={{ color: '#B45309', fontSize: 12, marginTop: 2 }}>Các dòng bên dưới là dữ liệu/cấu hình máy chủ hoặc mẫu hệ thống. Không tự xem mã tài khoản là mapping được duyệt; kết chuyển và ghi sổ vẫn qua gate riêng.</div>
      </div>
      {error && <div role="alert" className="mb-4 misa-p-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8 }}>
        <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không tải được catalogue tài khoản</div>
        <div style={{ color: '#B91C1C', fontSize: 12, marginTop: 2 }}>Không có dữ liệu thay thế từ giao diện.</div>
      </div>}
