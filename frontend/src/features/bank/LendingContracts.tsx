...
import { Table, Button, Input, Select, InputNumber, DatePicker, Space, Tag, Radio, Tabs } from 'antd';
    ...
    return (
        <div className="misa-page-layout">
            ...
            <div className="misa-p-12 misa-mb-16" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
                <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Workflow cho vay chưa khả dụng</div>
                <div style={{ color: '#B45309', fontSize: 12 }}>Backend hiện chỉ công bố khế ước đi vay. Giao diện không dùng endpoint đó cho dữ liệu cho vay và không hiển thị số liệu mẫu.</div>
            </div>
