...
import { Table, Button, Input, Select, InputNumber, Space, Tag, Popconfirm } from 'antd';
    ...
    return (
        <div className="misa-page-layout-p16">
            ...
            <div className="misa-p-12 misa-mb-16" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
                <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Chuyển tiền nội bộ chưa khả dụng</div>
                <div style={{ color: '#B45309', fontSize: 12 }}>Backend chưa công bố endpoint tạo, ghi sổ, bỏ ghi sổ hoặc truy vấn chuyển tiền nội bộ. Giao diện không hiển thị dữ liệu mẫu và không tự hạch toán.</div>
            </div>
