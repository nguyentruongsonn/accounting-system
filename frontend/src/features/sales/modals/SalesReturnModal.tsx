...
export const SalesReturnModal: React.FC<SalesReturnModalProps> = ({
    ...
    return (
        ...
        >
            {lookupError && (
                <div role="alert" className="misa-mb-12 misa-p-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                        <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải danh mục cho phiếu hàng bán trả lại</div>
                        <div style={{ color: '#B91C1C', fontSize: 12, marginTop: 2 }}>Danh sách khách hàng, nhân viên hoặc hàng hóa chưa tải được. Dữ liệu đã tải trước đó vẫn được giữ lại; hãy thử lại.</div>
                    </div>
