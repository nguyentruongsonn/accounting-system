        ...
        <PageShell>
            ...
            <div className="misa-action-bar">
                ...
                <div className="misa-action-bar-right">
                    ...
                    <Button className="misa-btn-tool" icon={<ReloadOutlined />} onClick={() => void runManualDataLoad(() => refetchQuotes(), { success: 'Tải lại danh sách báo giá thành công.', failure: 'Không thể tải lại danh sách báo giá.' })} title="Nạp lại">
                        Nạp
                    </Button>
                </div>
            </div>
            ...
            >
                {hasCatalogueError && (
                    <div role="alert" className="misa-mb-8 misa-p-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div>
                            <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải danh mục cho báo giá</div>
                        ...
                        <Button size="small" onClick={retryCatalogues}>Thử lại danh mục báo giá</Button>
                    </div>
                )}
