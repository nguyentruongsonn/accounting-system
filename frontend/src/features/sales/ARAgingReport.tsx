        ...
        return (
            ...
            />}>
                    ...
                    {v2Report.isError ? (
                        ...
                        <div role="alert" className="misa-p-12 mb-4" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}><div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Chọn ngày chốt để chạy báo cáo v2; giao diện không tự suy ra ngày as-of.</div></div>
                    ) : (
                        <DataTableSurface>
