...
import { SalesReturnAccountingTab } from './SalesReturnAccountingTab';
import { SalesReturnTaxTab } from './SalesReturnTaxTab';
import { SalesReturnCogsTab } from './SalesReturnCogsTab';
import { SalesReturnStatisticTab } from './SalesReturnStatisticTab';
import type { SalesReturnLine, InventoryItemOption } from '../types';

export interface SalesReturnGridProps {
    activeTab: 'accounting' | 'tax' | 'cogs' | 'statistic';
...
export const SalesReturnGrid: React.FC<SalesReturnGridProps> = ({
    activeTab,
    lines,
    items,
    disabled = false,
                        ...
                        <tr>
                            ...
                            {activeTab === 'accounting' && (
                                <>
                                    ...
                                    <th className="misa-w-130 misa-text-right">Đơn giá bán</th>
                            ...
                            {activeTab === 'cogs' && (
                                <>
                                    <th className="misa-w-100">Mã kho</th>
                                    <th className="misa-w-90 misa-text-center">TK Nợ kho</th>
                                    <th className="misa-w-90 misa-text-center">TK Có giá vốn</th>
                                    <th className="misa-w-130 misa-text-right">Đơn giá vốn</th>
                                    <th className="misa-w-140 misa-text-right">Tiền giá vốn</th>
                                </>
                            )}
                            {activeTab === 'statistic' && (
                                <>
...
export default SalesReturnGrid;
