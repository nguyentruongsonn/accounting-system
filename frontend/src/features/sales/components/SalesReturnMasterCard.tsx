...
export interface SalesReturnMasterCardProps {
    form: FormInstance;
    ...
    onIsInwardChange: (checked: boolean) => void;
...
export const SalesReturnMasterCard: React.FC<SalesReturnMasterCardProps> = ({
    form,
    paymentMethod,
    isInward,
    isViewMode = false,
            ...
            <div className="misa-config-bar">
                <div className="misa-config-bar-left">
                    ...
                    <div className="misa-flex-center misa-gap-12 misa-ml-16">
                        <Checkbox
                            checked={isInward}
                            onChange={e => onIsInwardChange(e.target.checked)}
                            disabled={isViewMode}
                            className="misa-checkbox-bold"
                        >
                            <span className="misa-text-semibold">Kiêm phiếu nhập kho</span>
                        </Checkbox>
                    </div>
                </div>
                        ...
                        <div className="misa-form-grid">
                            ...
                            <div className="misa-col-8">
                                ...
                                <Form.Item name="customer_address" noStyle>
                                    <Input disabled={isViewMode} className="misa-input" placeholder="Địa chỉ giao hàng" />
                                </Form.Item>
                            </div>
                            ...
                            <div className="misa-col-4">
                                ...
                                <Form.Item name="receiver_name" noStyle>
                                    <Input disabled={isViewMode} className="misa-input" placeholder="Họ tên người giao" />
                                </Form.Item>
                            </div>
                            ...
                            <div className="misa-col-12">
                                <div className="misa-field-label">Lý do trả lại</div>
                                <Form.Item name="description" noStyle>
                                    <Input disabled={isViewMode} className="misa-input" placeholder="Lý do xuất trả hàng..." />
                                </Form.Item>
                            </div>
                        </div>
                    </div>
...
export default SalesReturnMasterCard;
