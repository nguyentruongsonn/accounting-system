...
export interface SalesDiscountAccountingTabProps {
...
export const SalesDiscountAccountingTab: React.FC<SalesDiscountAccountingTabProps> = ({
    line,
    index,
    disabled = false,
    onUpdateLine
...
export default SalesDiscountAccountingTab;
