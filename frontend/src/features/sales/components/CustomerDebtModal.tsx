    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 16 }}>
                ...
                <div style={{ background: '#ebf5ff', border: '1px solid #bfdbfe', borderRadius: 6, padding: '10px 14px' }}>
                    <div style={{ fontSize: 12, color: '#0064e0', display: 'flex', alignItems: 'center', gap: 6 }}>
                        <CheckCircleOutlined style={{ color: '#0064e0' }} />
                        <span>Hạn mức nợ</span>
                    </div>
                    <div style={{ fontSize: 18, fontWeight: 700, color: '#0064e0', marginTop: 4 }}>
