export type PurchaseDimensionSelectionContext = {
...
export function canEditPurchaseDimensions(input: {
  isPosted: boolean;
  context?: PurchaseDimensionSelectionContext;
...
export function shortPolicyHash(hash?: string): string {
