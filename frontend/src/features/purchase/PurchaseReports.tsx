    ...
    <PageToolbar
      ...
      actions={(
        <div className="ui-page-toolbar__action-group flex items-center gap-2">
          <Button
            icon={<ReloadOutlined />}
            onClick={() => void runManualDataLoad(() => reportQuery.refetch(), { success: 'Tải lại báo cáo mua hàng thành công.', failure: 'Không thể tải lại báo cáo mua hàng.' })}
    ...
    >
      ...
      <DataTableSurface>
        ...
        {reportQuery.isError && (
          ...
          >
            <div>
              <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải báo cáo mua hàng</div>
            ...
            <Button size="small" onClick={() => void runManualDataLoad(() => reportQuery.refetch(), { success: 'Tải lại báo cáo mua hàng thành công.', failure: 'Không thể tải lại báo cáo mua hàng.' })}>Thử lại</Button>
          </div>
        )}
        {suppliersQuery.isError && (
          ...
          >
            <div>
              <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Không thể tải danh mục nhà cung cấp</div>
              <div style={{ color: '#B45309', fontSize: 12, marginTop: 2 }}>Báo cáo vẫn hiển thị theo bộ lọc hiện tại; hãy thử lại để chọn nhà cung cấp.</div>
            </div>
            <Button size="small" onClick={() => void runManualDataLoad(() => suppliersQuery.refetch(), { success: 'Tải lại danh mục nhà cung cấp thành công.', failure: 'Không thể tải lại danh mục nhà cung cấp.' })}>Thử lại danh mục nhà cung cấp</Button>
          </div>
        )}
