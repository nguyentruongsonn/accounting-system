...
export const PurchaseDashboard: React.FC = () => {
    ...
    const colors = ['#2563eb', '#0ea5e9', '#f59e0b', '#ec4899', '#8b5cf6'];
    const handleRefresh = () => void runManualDataLoad(() => refetch(), {
        success: 'Tải lại dashboard thành công.',
        failure: 'Không thể tải lại dashboard.',
    });
    ...
    if (isError || !stats) {
        return (
            <div className="misa-page-layout-gray">
                ...
                >
                    <div>
                        <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải dữ liệu dashboard</div>
                        <div style={{ color: '#B91C1C', fontSize: 12, marginTop: 2 }}>Máy chủ không trả về dữ liệu hợp lệ; không hiển thị số liệu thay thế.</div>
                    </div>
                    <Button size="small" onClick={handleRefresh}>Thử lại dashboard</Button>
                </div>
            </div>
        );
    }
            ...
            <div className="misa-dashboard-stat-grid">
                ...
                <div className="misa-dashboard-card">
                    ...
                    <div className="misa-dashboard-card-footer">
                        ...
                        <button type="button" onClick={handleRefresh} className="misa-btn-plain-primary">
