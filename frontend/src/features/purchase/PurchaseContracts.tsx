...
import { Table, Button, Input, Select, DatePicker, Form, InputNumber, Dropdown, Checkbox, Tabs, Space } from 'antd';
                        ...
                        <div className="ui-page-toolbar__action-group flex items-center gap-2">
                            <Button
                                ...
                                onClick={() => void runManualDataLoad(
                                    () => queryClient.invalidateQueries({ queryKey: ['purchase-contracts'] }),
                                    { success: 'Tải lại danh sách hợp đồng mua hàng thành công.', failure: 'Không thể tải lại danh sách hợp đồng mua hàng.' },
                                )}
                            />
                            <Button
