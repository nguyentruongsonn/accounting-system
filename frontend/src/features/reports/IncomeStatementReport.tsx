        ...
        />}>
            <PageToolbar
                filters={<Space>
                    ...
                    <Button icon={<ReloadOutlined />} onClick={() => void runManualDataLoad(() => refetch(), { success: 'Tải lại báo cáo kết quả kinh doanh thành công.', failure: 'Không thể tải lại báo cáo kết quả kinh doanh.' })}>Tải lại</Button>
                </Space>}
                actions={<Space>
