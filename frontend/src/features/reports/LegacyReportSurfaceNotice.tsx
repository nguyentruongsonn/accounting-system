...
const LegacyReportSurfaceNotice: React.FC<LegacyReportSurfaceNoticeProps> = ({
  ...
  return (
    <div className="misa-flex-col-gap-12 misa-p-16">
      <div role="alert" className="misa-p-12" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
        <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>{`Chưa có nguồn dữ liệu cho báo cáo ${moduleName}`}</div>
