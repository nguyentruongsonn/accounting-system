...
import { ConfigProvider, Table, Button, Form, Input, InputNumber, Space, Select, DatePicker, Tabs, Popconfirm } from 'antd';
        ...
        <PageShell title={<PageHeader eyebrow="Tiền lương" title="Bảng lương & Hạch toán chi phí" description="Quản lý các kỳ trả lương và trạng thái ghi sổ." />} toolbar={<PageToolbar leading={<Button type="default" icon={<FileTextOutlined />}>Báo cáo</Button>} actions={<Space>
            ...
            <DataTableSurface className="payroll-vouchers-table-surface">
                {(isPayrollsError || isAccountsError || isEmployeesError) && (
                    <div role="alert" className="misa-p-12 mb-3" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div>
                            <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải dữ liệu bảng lương</div>
                            <div style={{ color: '#B91C1C', fontSize: 12 }}>Danh sách hoặc danh mục liên quan chưa được máy chủ trả về; không dùng dữ liệu rỗng thay thế.</div>
                        </div>
