...
export function CashReports({ active = true }: CashReportsProps) {
  ...
  return (
    <PageShell className="cash-reports-page">
      ...
      {actionError && <div role="alert" className="misa-p-12 misa-mb-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, color: '#991B1B', fontWeight: 500, fontSize: 13 }}>{actionError}</div>}
