  ...
  if (error) {
    return (
      <section className="cash-report-result" aria-live="polite">
        <div role="alert" className="misa-p-12 misa-mb-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải báo cáo tiền mặt</div>
            <div style={{ color: '#B91C1C', fontSize: 12 }}>Máy chủ không trả về dữ liệu báo cáo hợp lệ. Hãy thử lại.</div>
          </div>
