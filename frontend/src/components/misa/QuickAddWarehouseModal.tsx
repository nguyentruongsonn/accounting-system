        ...
        >
            ...
            {accountsQuery.isError ? (
                <div className="misa-p-12 misa-mb-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div>
                        <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải danh mục tài khoản kho</div>
                        <div style={{ color: '#B91C1C', fontSize: 12 }}>Không có dữ liệu thay thế; hãy thử lại khi máy chủ sẵn sàng.</div>
                    </div>
                    <Button size="small" onClick={() => void accountsQuery.refetch()}>Thử lại</Button>
                </div>
            ) : null}
