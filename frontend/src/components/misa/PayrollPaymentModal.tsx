...
import { InputNumber, Button, Table, DatePicker, Select } from 'antd';
        ...
        >
            {tableData.length === 0 && (
                <div className="apple-section-gap misa-p-12 misa-mb-12" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
                    <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Chi trả lương chưa khả dụng</div>
                    <div style={{ color: '#B45309', fontSize: 12 }}>Chưa có API cung cấp bảng lương và số dư phải trả đã kiểm chứng; không thể lập phiếu chi từ danh mục nhân viên.</div>
                </div>
            )}
