...
import { Steps, Button, Upload, Table, Tag, Radio, Select } from 'antd';
...
export const ExcelImportModal: React.FC<ExcelImportModalProps> = ({
    ...
    return (
        ...
        >
            ...
            >
            <div className="apple-section-gap misa-p-12 misa-mb-12" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
                <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Nhập Excel chưa khả dụng</div>
                <div style={{ color: '#B45309', fontSize: 12 }}>Backend chưa công bố endpoint upload/validate/import Excel cho phiếu thu, phiếu chi hoặc chứng từ mua hàng. Giao diện không báo nhập thành công giả.</div>
            </div>
