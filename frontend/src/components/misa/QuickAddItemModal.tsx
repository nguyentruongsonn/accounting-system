...
import { Form, Input, InputNumber, Select, Button, Tabs, Tag, Space, Radio, Upload, Popconfirm } from 'antd';
            ...
            >
                ...
                {catalogueError ? (
                    <div className="misa-p-12 misa-mb-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div>
                            <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải danh mục hàng hóa</div>
                            <div style={{ color: '#B91C1C', fontSize: 12 }}>Một hoặc nhiều danh mục chưa được máy chủ trả về hợp lệ; không dùng dữ liệu mẫu thay thế.</div>
                        </div>
                        <Button size="small" onClick={retryCatalogues}>Thử lại</Button>
                    </div>
                ) : null}
