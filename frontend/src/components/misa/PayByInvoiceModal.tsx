        ...
        >
            {(suppliersLoadError || invoicesLoadError) && (
                <div className="misa-p-12 misa-mb-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div>
                        <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải dữ liệu trả tiền theo hóa đơn</div>
                        <div style={{ color: '#B91C1C', fontSize: 12 }}>Danh sách nhà cung cấp hoặc hóa đơn chưa tải được. Dữ liệu cũ được giữ lại; hãy thử lại.</div>
                    </div>
