        ...
        >
            ...
            {categoriesLoadError && (
                <div className="misa-p-12 misa-mb-12" style={{ background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div>
                        <div style={{ fontWeight: 600, color: '#991B1B', fontSize: 13 }}>Không thể tải danh mục nhóm hàng hóa</div>
                        <div style={{ color: '#B91C1C', fontSize: 12 }}>Danh sách nhóm cha chưa tải được. Hãy thử lại trước khi chọn nhóm.</div>
                    </div>
                    <Button size="small" onClick={() => void categoriesQuery.refetch()}>Thử lại</Button>
                </div>
            )}
