    ...
    return (
        ...
        >
            <div className="apple-section-gap misa-p-12 misa-mb-12" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
                <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Nộp thuế chưa khả dụng</div>
                <div style={{ color: '#B45309', fontSize: 12 }}>Chưa có API cung cấp nghĩa vụ thuế, cơ quan thụ hưởng và chứng từ nguồn; không thể lập phiếu chi từ dữ liệu mẫu.</div>
            </div>
