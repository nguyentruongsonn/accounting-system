    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-100">
                ...
                <div className="misa-p-12 mb-6" style={{ background: '#FFFBEB', border: '1px solid #FDE68A', borderRadius: 8 }}>
                    <div style={{ fontWeight: 600, color: '#92400E', fontSize: 13 }}>Đăng ký tài khoản chưa khả dụng</div>
                    <div style={{ color: '#B45309', fontSize: 12 }}>Hệ thống hiện chưa công bố endpoint đăng ký tự phục vụ. Không gửi dữ liệu biểu mẫu đến endpoint không tồn tại.</div>
                </div>
